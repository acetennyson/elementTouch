...
export default class DataTables {
    ...
    createDataTable(params){
        ...
        this.language = params.language || this.parent.usersProps.language || {
            ...
            paginate: {
                ...
                size: [
                       '<li class="page-link cursor-pointer" data-value="3">3</li>',
                       '<li class="page-link cursor-pointer" data-value="10">10</li>',
                       '<li class="page-link cursor-pointer" data-value="15">15</li>'
                ]
            }
        };
    ...
    addPaginationControls() {
        ...
        sizeBar.classList.add('ms-auto', 'd-flex', 'flex-row', 'ps-3');
        this.language.paginate.size.forEach(list=>{
            let divv = document.createElement('div');
            divv.innerHTML = list;
            divv.firstChild.addEventListener('click', (ev)=>{
                let size = ev.target.dataset.value;
                this.eventbus.dispatch('sizeChange', size);
            })
            sizeBar.appendChild(divv.firstChild);
        })
        paginationDiv.appendChild(sizeBar);
